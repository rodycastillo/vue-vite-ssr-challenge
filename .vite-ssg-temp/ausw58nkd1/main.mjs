import { resolveComponent, mergeProps, withCtx, createVNode, useSSRContext, resolveDynamicComponent, openBlock, createBlock, Suspense } from "vue";
...
const routes = [
  {
    path: "/",
    name: "Home",
    component: () => import("./assets/Home-3c51cb1d.js"),
    meta: {
      requiresAuth: true
    }
  },
  {
    path: "/recharges",
    name: "Recharges",
    component: () => import("./assets/Recharges-c02eb18f.js"),
    meta: {
      requiresAuth: true
    }
  },
  {
    path: "/error",
    name: "Error",
    component: () => import("./assets/Error-10f5719e.js"),
    meta: {
      requiresAuth: false
    }
  }
...
const createApp = ViteSSG(
  ...
  ({ app, router, routes: routes2, isClient, initialState }) => {
    ...
    app.use(VueQueryPlugin).use(pinia).use(head);
    if (isClient) {
